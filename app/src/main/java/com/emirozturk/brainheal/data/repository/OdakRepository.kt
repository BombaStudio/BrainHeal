package com.emirozturk.brainheal.data.repository
...
class OdakRepository(
    ...
    suspend fun importBackupData(data: com.emirozturk.brainheal.util.ParsedBackupData, replaceExisting: Boolean) {
        if (replaceExisting) {
